...
| Premature development plan in original main | [Historical planning file at baseline commit](https://github.com/hamthet/WinSidebar/blob/362bda88b7e9da26fa8b3200fda6ce73478d3f2d/docs/i18n/LOCALIZATION-PLAN.md) | The old plan **was** on `main` at the starting SHA. It was subsequently removed from `main` in [`f291352`](https://github.com/hamthet/WinSidebar/commit/f291352b7456227d221b3708fd8a283925dc3143) and `develop` in [`1b7ebb4`](https://github.com/hamthet/WinSidebar/commit/1b7ebb43356c464bc55f47351b8f07f3df9f905c). The current canonical plan is `development/PLAN.md`. Recheck the final release tree independently. |
