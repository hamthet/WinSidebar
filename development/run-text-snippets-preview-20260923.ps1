...
$expected = @{    'src/WinSidebar.cs'            = 'e20cf1426d774f4857302f68e192e70cbe963e9c'
...
Write-Host '  B. Collapse the sidebar, then press AltGr+Y (AltGr+Y (registered as Ctrl+Alt+Y)). It must open the sidebar.'
Write-Host '  C. Press AltGr+Y again while already open: no second action, popup or duplicate effect.'
