...
$expected = @{    'src/WinSidebar.cs'            = 'af97f20a63afa6a4f3365e60bbf3554463c18cc4'
...
Write-Host '  B. Collapse the sidebar, then press Ctrl+" (Ctrl+Shift+the quote/apostrophe key). It must open the sidebar.'
Write-Host '  C. Press Ctrl+" again while already open: no second action, popup or duplicate effect.'
