...
1. Скачайте ZIP версии 2.0.0 и распакуйте его в доступную вам папку.
...
Прежняя навигация по списку окон через Shift+F в 2.0.0 отсутствует.
...
WinSidebar 2.0.0 предназначен для Windows x64 и публикуется как один самодостаточный исполняемый файл. Runtime .NET 8 встроен в WinSidebar.exe. Пользователю не нужны отдельные .NET, PowerShell, Git, компилятор или установщик.
